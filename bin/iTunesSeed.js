...
program
  ...
  .description("Seeds the synced-in database with metadata from an XML iTunes library file. " +
               "By default, we'll import synced-in's music.xml and your iTunes library.")
